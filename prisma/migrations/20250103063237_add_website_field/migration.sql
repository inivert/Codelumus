...
CREATE TABLE "admin_updates" (
    ...
    CONSTRAINT "admin_updates_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "users_website_key" ON "users"("website");
...
-- CreateIndex
CREATE INDEX "admin_updates_userId_idx" ON "admin_updates"("userId");
...
-- AddForeignKey
ALTER TABLE "admin_updates" ADD CONSTRAINT "admin_updates_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
